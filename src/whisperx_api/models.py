...
class TranscriptParams(BaseModel):
    ...
    speaker_labels: bool | None = Field(
        None, description="Enable speaker diarization (default: false)"
    )
    speakers_expected: int | None = Field(
        None, description="Expected number of speakers (sets both min and max)"
    )
    ...
    temperature: float | None = Field(
        None, ge=0.0, le=1.0, description="Sampling temperature (default: 0.0)"
    )
    beam_size: int | None = Field(None, ge=1, le=10, description="Beam search size (default: 5)")
    best_of: int | None = Field(
        None, ge=1, description="Number of sampling alternatives (default: 5)"
    )
    patience: float | None = Field(
        None, ge=0.0, description="Beam search patience factor (default: 1.0)"
    )
    length_penalty: float | None = Field(
        None, description="Exponential length penalty (default: 1.0)"
    )
    ...
    word_timestamps: bool | None = Field(
        None, description="Include word-level timestamps (default: true)"
    )
    return_char_alignments: bool | None = Field(
        None, description="Include character-level alignments (default: false)"
    )
    suppress_numerals: bool | None = Field(
        None, description="Spell out numbers instead of digits (default: false)"
    )

    # Hallucination filtering
    compression_ratio_threshold: float | None = Field(
        None, description="Filter high compression segments (default: 2.4)"
    )
    no_speech_threshold: float | None = Field(
        None, ge=0.0, le=1.0, description="Silence detection threshold (default: 0.6)"
    )
    condition_on_previous_text: bool | None = Field(
        None, description="Use previous output as prompt (default: false)"
    )

    # VAD parameters
    vad_onset: float | None = Field(
        None, ge=0.0, le=1.0, description="VAD speech onset threshold (default: 0.5)"
    )
    vad_offset: float | None = Field(
        None, ge=0.0, le=1.0, description="VAD speech offset threshold (default: 0.363)"
    )
    chunk_size: int | None = Field(
        None, ge=1, le=300, description="Maximum audio chunk duration in seconds (default: 30)"
    )
